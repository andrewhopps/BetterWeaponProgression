...
public class BWPGoldenSword extends BWPSwordItem{
    ...
    public BWPGoldenSword(Tier tier, int adjustedDmg, float adjustedSpeed, Properties properties) {
	...
	public static final RegistryObject<SwordItem> BWPGOLDENSWORD = BWPModItemInit.ITEMS.register("bwpmod_golden_sword", 
			() -> new BWPGoldenSword(Tiers.GOLD, 6, -2.4f, new Item.Properties().tab(BWPMod.BWPMod_TAB).durability(450)));
